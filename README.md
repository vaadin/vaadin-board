...
Vaadin Board is distributed under [Commercial Vaadin Add-on License version 3](https://vaadin.com/license/cvdl-4.0) (CVDLv4). For license terms, see LICENSE.txt.
